...
import { Text, CodeBlock, Title, BrandButton, Block, Notice, Column, Grid, GridItem, Flex, useTheme } from '@platform-blocks/ui';
    ...
    <PageLayout>
      <ScrollView showsVerticalScrollIndicator={false}>
        <Flex direction="column" p="lg">
          ...
          />
          <Text variant="p" colorVariant="secondary" mb="xl">
