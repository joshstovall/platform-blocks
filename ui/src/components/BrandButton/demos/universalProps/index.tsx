    ...
    <Card p="lg">
      <Flex direction="column" gap="lg">
        ...
        <Flex direction="column" gap="md">
          <Text variant="caption" weight="600">Light Mode Only (darkHidden):</Text>
        ...
        <Flex direction="column" gap="md">
          <Text variant="caption" weight="600">Dark Mode Only (lightHidden):</Text>
          <Flex direction="row" gap="sm" wrap="wrap">
        ...
        <Flex direction="column" gap="md">
          <Text variant="caption" weight="600">Responsive Visibility:</Text>
          <Flex direction="row" gap="sm" wrap="wrap">
        ...
        <Flex direction="column" gap="md">
          <Text variant="caption" weight="600">Combined Props:</Text>
          <Flex direction="row" gap="sm" wrap="wrap">
            <BrandButton 
              brand="discord" 
