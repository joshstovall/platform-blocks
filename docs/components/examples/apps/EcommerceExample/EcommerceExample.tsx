                  ...
                  <Flex direction="row" gap={12}>
                    <View style={styles.cartItemImage}>
                      <Image
                        ...
                        fallback={<Icon name="image-off" size="lg" color={theme.colors.gray[5]} />}
                      />
                    </View>
                    <View style={{ flex: 1 }}>
  ...
  return (
    <PageLayout>
      <View>
        ...
        <View style={[styles.headerBar, { backgroundColor: theme.colors.primary[9], borderBottomColor: theme.colors.primary[8], borderBottomWidth: 1 }]}>
          <Text style={[styles.brand, { color: theme.colors.secondary[4] }]}>PlatformBlocksMart</Text>
        ...
        {/* Category Bar */}
    <View style={[styles.categoryBar, { backgroundColor: theme.colors.primary[0], borderBottomColor: theme.colors.primary[2] }]}>
          <Tabs
      ...
      variant="line"
        ...
        {/* Hero Offer */}
  <Card variant="filled" style={[styles.hero, { backgroundColor: theme.colors.primary[8] }]}>
          <Flex direction="row" align="center" justify="space-between">
            <View style={{ flex: 1, paddingRight: 16 }}>
              <Text size="xl" weight="bold" style={{ color: 'white', marginBottom: 4 }}>Rollback Savings Event</Text>
              ...
              <Button title="Shop Deals" variant="gradient" size="sm" style={{ marginTop: 12 }} endIcon={<Icon name="chevronRight" size="sm" />} />
            </View>
          ...
          <View style={styles.mainContentRow}>
            ...
            <View style={{ flex: 1 }}>
              ...
              return matchesSearch && matchesCategory;
                ...
                <GridItem key={product.id} span={{ base: 6, md: 4 }}>
                ...
                <View style={styles.productImage}>
                  <Image
                    ...
                    fallback={<Flex align="center" justify="center" style={{ flex: 1 }}>
                      <Icon name="image-off" size="lg" color={theme.colors.gray[5]} />
                    </Flex>}
                  />
                  {!product.inStock && (
